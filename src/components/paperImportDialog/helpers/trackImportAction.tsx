import { IMPORT_SOURCE_TAB } from '@src/types/profile';
import ActionTicketManager from '@src/helpers/actionTicketManager';

type IMPORT_ACTION_TAG =
  | 'clickSubmitGSBtn'
...
function trackImportAction({ importSource, actionLabel }: Params) {
  ...
  switch (importSource) {
    case IMPORT_SOURCE_TAB.BIBTEX:
      actionTag = 'clickSubmitBibtexBtn';
      break;
    case IMPORT_SOURCE_TAB.GS:
      actionTag = 'clickSubmitGSBtn';
      break;
    case IMPORT_SOURCE_TAB.AUTHOR_URLS:
      actionTag = 'clickSubmitAuthorUrlsBtn';
      break;
    case IMPORT_SOURCE_TAB.CITATION:
