...
import { HandleImportPaperListParams, IMPORT_SOURCE_TAB } from '@src/types/profile';
  ...
  return (
    <div className={s.formWrapper}>
      ...
      <div className={s.formDescription}>
        Copy & Paste the URL of your author page on scinapse.
        <br />
      ...
      <Formik
        ...
        onSubmit={values =>
          onSubmitAuthorUrls({ type: IMPORT_SOURCE_TAB.AUTHOR_URLS, importedContext: values.authorUrls })
        }
                ...
                return (
                  <div>
                    {values.authorUrls.map((authorUrl, index) => {
                      return (
                        <div className={s.urlInputContainer} key={index}>
                          ...
                          />
                          {values.authorUrls.length > 1 && index === 0 && (
                    ...
                    <div className={s.submitBtn}>
                      {errors.authorUrls && typeof errors.authorUrls === 'string' && (
