...
import SuggestAPI, { SuggestAffiliation } from '@src/api/suggest';
...
import InputWithSuggestionList, { DefaultItemComponentProps } from '@src/components/InputWithSuggestionList';
    ...
    <div>
      {props.userInput.length > 0 && (
        ...
        >
          ...
          Enter <b>“{props.userInput}”</b> as your affiliation
        </div>
      )}
    </div>
  );
