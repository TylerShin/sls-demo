...
import { PDFViewerState } from '@src/reducers/pdfViewer';
import { getBestPdf } from '@src/actions/pdfViewer';
...
function trackClickButton(actionTag: ActionTagType, paperId: string) {
