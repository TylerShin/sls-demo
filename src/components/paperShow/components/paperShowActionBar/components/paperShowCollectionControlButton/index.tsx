...
import { collectionSchema, Collection } from '@src/model/collection';
import GlobalDialogManager from '@src/helpers/globalDialogManager';
import PaperNoteForm from '@src/components/noteForm';
import ScinapseButton from '@src/components/scinapseButton';
import {
